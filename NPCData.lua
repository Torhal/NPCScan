...
--WOD Beta Mobs
	...
	--["77140"] = { world_id = Unknown,         map_name= Unknown,          is_tamable = false, is_achievement = false }, -- Amaukwa
	...
	--["82058"] = { world_id = Unknown,         map_name= "Unknown",          is_tamable = false, is_achievement = true }, -- Depthroot
	["82085"] = { world_id = ZN.DRAENOR,         map_name= ZN.GORGROND,          is_tamable = false, is_achievement = false }, -- Bashiok
	["82170"] = { world_id = ZN.DRAENOR,         map_name= ZN.SHADOWMOON_VALLEY,          is_tamable = false, is_achievement = false }, -- Anchorite Vaanala
...
for npc_id, data in pairs(NPC_DATA) do
	...
	private.NPC_NAME_TO_ID[L.NPCs[npc_id]] = npc_id
	if data.is_tamable then
		...
		if not data.is_achievement then
			private.TAMABLE_NON_ACHIEVMENT_LIST[npc_id] = L.NPCs[npc_id]
		end
